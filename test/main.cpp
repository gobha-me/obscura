...
// event listener. Anything shared across the whole suite — a database, a
// broker, a container, any service the tests talk to — belongs in the ctest
// fixtures (cmake/startup.sh and cmake/shutdown.sh), which run once for the
// entire run and are wired up in test/CMakeLists.txt.
